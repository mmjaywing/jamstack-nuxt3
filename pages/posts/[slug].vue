    ...
    <div class="flex flex-col py-20 px-4 bg-white">
        <div class="container mx-auto flex flex-col md:flex-row relative z-20 justify-between gap-6">
            <div class="md:w-1/2 flex flex-col gap-6">
                ...
                <p class="text-[#101014]">Cras justo odio, dapibus ac facilisis in, egestas eget quam. Cras mattis
                ...
                <p class="text-[#101014]">Nulla vitae elit libero, a pharetra augue. Morbi leo risus, porta ac
                ...
                <NuxtLink to="/about/" aria-label="content" class="!bg-[#101014] !text-white btn w-full md:w-auto">
                    <span>Wines</span>
                </NuxtLink>
            </div>
